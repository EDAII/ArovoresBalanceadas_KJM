...
Nossa dupla realizou algumas questões da plataforma LeetCode, no intuito de colocar em prática os conhecimentos adquiridos sobre o conteúdo Árvores Balanceadas.
## Questões
...
Este problema pede para receber a raiz de uma Árvore Binária de Busca (BST) e retornar uma nova BST balanceada que contenha exatamente os mesmos valores.
